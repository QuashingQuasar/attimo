...
If you have ever looked at [a Certificate of Analysis for olive oil ](https://attimo-oil.com/lab/Coratina2025.pdf)and felt like you were reading a blood test for a plant, readon. The document is dense, the units are unfamiliar, and nobody explains what any of it means in practical terms.

This is a problem because the lab report is the only document that tells you what is actually in a bottle of olive oil. The label tells you the grade (extra virgin), the origin (usually vague), and the best-before date (mostly useless).

The lab report tells you the polyphenol content, the freshness markers, the acidity, the individual bioactive compounds, and whether the oil is actually what the label claims it is.
...
**What it tells you:** How carefully the fruit was handled and how quickly it was processed. An oil with 0.19% acidity ([like our Coratina](/product/coratina)) means the olives were picked intact, transported without damage, and pressed within hours. An oil at 0.7% got there through some combination of bruised fruit, delayed processing, or poor handling. Both technically qualify as extra virgin. The difference in care is measurable.
...
**What it measures:** The concentration of oleuropein, the principal phenolic glycoside of the olive, along with its aglycone forms, in mg/kg.

**Where it comes from:** Oleuropein is the most abundant polyphenol in the raw olive fruit and in olive leaves. It is the compound responsible for the harsh bitterness of an olive picked straight from the tree, before curing. When the olives are crushed and the paste is kneaded (malaxation), an enzyme called beta-glucosidase strips the sugar off oleuropein and converts it into a family of smaller compounds: its aglycone forms first, and from there oleacein and free hydroxytyrosol. A closely related compound, ligstroside, runs through the same process to produce oleocanthal and tyrosol. This is why intact oleuropein is usually present only in small amounts in finished oil. Most of it has already been transformed into the compounds that carry the flavour and the documented health activity.

**Why it matters:** Oleuropein is the reservoir the rest of the secoiridoid profile is drawn from. On its own it has documented antioxidant, anti-inflammatory and antimicrobial activity, and most of the research on olive leaf extract is built on it. In oil, though, its significance is mainly as the precursor. A green, early-harvest olive carries a heavy oleuropein load, which is why the resulting oil ends up rich in oleacein and hydroxytyrosol. A ripe, late-harvest olive has already broken much of its oleuropein down on the tree, which is part of why late-harvest oils taste milder and test lower in bioactives.

**What to look for:** This is where headline numbers get slippery. Some COAs report oleuropein or "oleuropein aglycon" as a single large figure. As a chemical classification it is real, but it describes a precursor and a structural family, not the specific bioactives (oleocanthal, oleacein, hydroxytyrosol) the health research is built on. A high oleuropein-aglycone number sitting alongside modest oleocanthal and oleacein tells you the oil is rich in raw secoiridoid material; it does not, on its own, tell you how much of the most-studied compounds are present. Read it as context for the compound breakdown, not as a replacement for it.
...
## Not all polyphenols are equal, and some numbers can be misleading
...
1. What method was used for the total?
1. Is the impressive number driven by the bioactive compounds, or by everything else?
...
**A fresh, high-quality early-harvest oil** will show: 

- low acidity (below 0.3%)
- low peroxide (below 9)
- high polyphenols (above 400 mg/kg)
- meaningful oleocanthal and oleacein concentrations
- high DAGs (above 90%)
- low PPPs (below 5%)
- high oleic acid (above 65%).
**A commercial oil approaching its limits** will show: 

- acidity creeping toward 0.8%
- peroxide above 15
- polyphenols below 200 mg/kg
- no compound breakdown available
- DAGs below 85%
- PPPs climbing
**An old or degraded oil** will show:

- peroxide that may actually be low (because peroxides have decomposed into secondary products)
- K270 elevated
- DAGs below 80%
- PPPs above 17%
- polyphenols significantly reduced from whatever they were at pressing
...
1. Beauchamp GK, Keast RSJ, Morel D, et al. Phytochemistry: ibuprofen-like activity in extra-virgin olive oil. *Nature*. 2005;437:45–46. [https://doi.org/10.1038/437045a](https://doi.org/10.1038/437045a)
1. Estruch R, Ros E, Salas-Salvadó J, et al. Primary prevention of cardiovascular disease with a Mediterranean diet supplemented with extra-virgin olive oil or nuts (PREDIMED). *New England Journal of Medicine*. 2018;378:e34. [https://doi.org/10.1056/NEJMoa1800389](https://doi.org/10.1056/NEJMoa1800389)
1. EFSA Panel on Dietetic Products, Nutrition and Allergies (NDA). Scientific Opinion on the substantiation of health claims related to polyphenols in olive oil. *EFSA Journal*. 2011;9(4):2033. [https://doi.org/10.2903/j.efsa.2011.2033](https://doi.org/10.2903/j.efsa.2011.2033)
1. Commission Regulation (EU) No 432/2012 establishing a list of permitted health claims made on foods. *Official Journal of the European Union*. [https://eur-lex.europa.eu/eli/reg/2012/432/oj](https://eur-lex.europa.eu/eli/reg/2012/432/oj)
1. International Olive Council. Trade Standard Applying to Olive Oils and Olive Pomace Oils (COI/T.15/NC No 3). [https://www.internationaloliveoil.org/what-we-do/chemistry-standardisation-unit/standards-and-methods/](https://www.internationaloliveoil.org/what-we-do/chemistry-standardisation-unit/standards-and-methods/)
1. Commission Regulation (EEC) No 2568/91 on the characteristics of olive oil and the relevant methods of analysis. *Official Journal*. [https://eur-lex.europa.eu/eli/reg/1991/2568/oj](https://eur-lex.europa.eu/eli/reg/1991/2568/oj)
1. US Food and Drug Administration. Qualified health claim for oleic acid and reduced risk of coronary heart disease (Docket FDA-2017-Q-5749). 2018. [https://www.fda.gov/food/cfsan-constituent-updates/fda-completes-review-qualified-health-claim-petition-oleic-acid-and-risk-coronary-heart-disease](https://www.fda.gov/food/cfsan-constituent-updates/fda-completes-review-qualified-health-claim-petition-oleic-acid-and-risk-coronary-heart-disease)
1. LeGendre O, Breslin PAS, Foster DA. (-)-Oleocanthal rapidly and selectively induces cancer cell death via lysosomal membrane permeabilization. *Molecular & Cellular Oncology*. 2015;2(4):e1006077. [https://doi.org/10.1080/23723556.2015.1006077](https://doi.org/10.1080/23723556.2015.1006077)
1. Abuznait AH, Qosa H, Busnena BA, El Sayed KA, Kaddoumi A. Olive-oil-derived oleocanthal enhances β-amyloid clearance as a potential neuroprotective mechanism against Alzheimer's disease. *ACS Chemical Neuroscience*. 2013;4(6):973–982. [https://doi.org/10.1021/cn400024q](https://doi.org/10.1021/cn400024q)
1. Monti MC, Margarucci L, Tosco A, Riccio R, Casapullo A. New insights on the interaction mechanism between tau protein and oleocanthal using STD-NMR spectroscopy. *Food & Function*. 2011;2(7):423–428. [https://doi.org/10.1039/c1fo10064e](https://doi.org/10.1039/c1fo10064e)
1. Rao CV, Newmark HL, Reddy BS. Chemopreventive effect of squalene on colon cancer. *Carcinogenesis*. 1998;19(2):287–290. [https://doi.org/10.1093/carcin/19.2.287](https://doi.org/10.1093/carcin/19.2.287)
1. O'Hagan DT, Ott GS, Van Nest G, Rappuoli R, Del Giudice G. The history of MF59 adjuvant. *Expert Review of Vaccines*. 2013;12(1):13–30. [https://doi.org/10.1586/erv.12.140](https://doi.org/10.1586/erv.12.140)
1. Robles-Almazan M, Pulido-Moran M, Moreno-Fernandez J, et al. Hydroxytyrosol: bioavailability, toxicity, and clinical applications. *Food Research International*. 2018;105:654–667. [https://doi.org/10.1016/j.foodres.2017.11.053](https://doi.org/10.1016/j.foodres.2017.11.053)
1. Filipek A, Czerwińska ME, Kiss AK, Wrzosek M, Naruszewicz M. Oleacein enhances anti-inflammatory activity of human macrophages by increasing CD163 receptor expression. *Phytomedicine*. 2015;22(14):1255–1261. [https://doi.org/10.1016/j.phymed.2015.10.005](https://doi.org/10.1016/j.phymed.2015.10.005)