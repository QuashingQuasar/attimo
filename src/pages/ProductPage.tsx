      ...
      <section className="lg:pt-24">
        <div className="w-full grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-0 items-start">
            ...
            <div className="px-6 md:px-10 lg:px-12 pt-8 md:pt-6 lg:pt-12 pb-8 md:pb-12 space-y-8">
              ...
              {/* Subtitle */}
              <p className="text-olive-medium !-mt-1 underline-offset-[8px]" style={{ fontFamily: 'Beverly Drive, cursive', fontWeight: 'bold', fontSize: 'clamp(1.34rem, 3.1vw, 3.1rem)', textDecoration: 'underline', textDecorationStyle: 'dashed', textDecorationColor: 'rgba(78, 91, 43, 0.4)', textUnderlineOffset: '8px' }}>
