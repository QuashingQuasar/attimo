      ...
      >
        ...
        <div className={`absolute inset-0 w-full h-full backface-hidden rounded-2xl bg-gradient-to-br ${card.front.bgColor} p-8 text-white shadow-lg`}>
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <p className="text-white/80 text-sm uppercase tracking-wide" style={{ fontFamily: 'Space Grotesk, monospace' }}>{card.front.subtitle}</p>
            <div className="mt-6 text-xs text-white/60" style={{ fontFamily: 'Space Grotesk, monospace' }}>Click to flip</div>
          </div>
        </div>
        ...
        <div className={`absolute inset-0 w-full h-full backface-hidden rotate-y-180 rounded-2xl bg-gradient-to-br ${card.back.bgColor} p-8 text-white shadow-lg`}>
          <div className="flex flex-col justify-center h-full">
            ...
            <p className="text-lg leading-relaxed text-white/95" style={{ fontFamily: 'Space Grotesk, monospace' }}>{card.back.content}</p>
            <div className="mt-6 text-center text-xs text-white/60" style={{ fontFamily: 'Space Grotesk, monospace' }}>Click to flip back</div>
          </div>
        </div>
      </div>
    </div>
...
export const PolyphenolStory = () => {
  ...
  return (
    <section className="pt-12 md:pt-16 lg:pt-24 pb-24 md:pb-28 lg:pb-36 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-light text-white mb-6">
            The Science Behind <span className="font-medium text-emerald-400">Polyphenols</span>
          </h2>
           <p className="text-xl text-slate-300 leading-relaxed max-w-3xl mx-auto" style={{ fontFamily: 'Space Grotesk, monospace' }}>
