      ...
      >
        ...
        <div className={`absolute inset-0 w-full h-full backface-hidden rotate-y-180 rounded-2xl bg-gradient-to-br ${card.back.bgColor} p-8 text-white shadow-lg`}>
          <div className="flex flex-col justify-center h-full">
            ...
            <p className="text-lg leading-relaxed text-white/95" style={{ fontFamily: 'Inconsolata, monospace' }}>{card.back.content}</p>
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-light text-white mb-6">
           ...
           <p className="text-xl text-slate-300 leading-relaxed max-w-3xl mx-auto" style={{ fontFamily: 'Inconsolata, monospace' }}>
