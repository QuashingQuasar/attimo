            ...
            <table className="w-full border-collapse">
              <thead>
                <tr style={{ borderBottom: '2px dashed #1B4229' }}>
                  ...
                  <th className="py-3 px-2 md:py-6 md:px-8 text-center font-bold font-working-man" style={{ color: '#1B4229', backgroundColor: '#B3E58C', fontSize: 'clamp(1rem, 1.8vw, 2rem)' }}>ATTIMO</th>
