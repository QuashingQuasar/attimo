                ...
                <div className="space-y-6">
                  <div className="text-center">
                    <div className="text-3xl font-bold text-olive-dark">904 MG/KG</div>
                     <div className="text-sm text-olive-medium" style={{ fontFamily: 'Space Mono, monospace' }}>POLYPHENOLS</div>
                     <div className="text-xs text-olive-light mt-1" style={{ fontFamily: 'Space Mono, monospace' }}>avg. ~180mg/kg</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-olive-dark">0.16%</div>
                     <div className="text-sm text-olive-medium" style={{ fontFamily: 'Space Mono, monospace' }}>ACIDITY</div>
                     <div className="text-xs text-olive-light mt-1" style={{ fontFamily: 'Space Mono, monospace' }}>avg. ~0.8%</div>
                  </div>
                  <div className="border rounded-lg overflow-hidden">
                    ...
                    <div className="p-4 text-center" style={{ backgroundColor: '#FFFAEA' }}>
                      ...
                      <div className="text-sm text-olive-medium" style={{ fontFamily: 'Space Mono, monospace' }}>MEQ/KG</div>
                      <div className="text-xs text-olive-light mt-1" style={{ fontFamily: 'Space Mono, monospace' }}>avg. ~20meq/kg</div>
                      <p className="mt-2 text-xs text-olive-medium" style={{ fontFamily: 'Space Mono, monospace' }}>lower = fresher oil, less oxidation and longer shelf life</p>
                    </div>
                  </div>
                </div>
              </CardContent>
