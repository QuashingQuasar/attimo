...
const carouselSlides = [
  ...
  {
    id: 2,
    title: "8,000+ Varieties",
    subtitle: "Nature's Diversity",
  ...
  },
  {
    ...
    visual: "🏆",
    bgGradient: "from-emerald-900 via-green-800 to-emerald-700",
    accent: "emerald"
  }
];
...
export const PolyphenolCarousel = () => {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      {/* Dynamic Background */}
      <div 
        className={`absolute inset-0 bg-gradient-to-br ${currentSlideData.bgGradient} transition-all duration-1000 ease-in-out`}
      >
        {/* Overlay Pattern */}
      ...
      <Button
        ...
        size="icon"
        onClick={prevSlide}
        className="absolute left-8 top-1/2 -translate-y-1/2 z-20 bg-white/10 hover:bg-white/20 text-white border-white/20 backdrop-blur-sm h-14 w-14"
      >
      ...
      <Button
        ...
        size="icon"
        onClick={nextSlide}
        className="absolute right-8 top-1/2 -translate-y-1/2 z-20 bg-white/10 hover:bg-white/20 text-white border-white/20 backdrop-blur-sm h-14 w-14"
      >
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-6">
        <div className="max-w-6xl mx-auto text-center">
          {/* Visual Element */}
          <div className="text-8xl md:text-9xl mb-8 animate-fade-in">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 md:p-16 border border-white/20 shadow-2xl">
            <div className="mb-6">
              <span className="text-white/70 text-sm font-medium uppercase tracking-wider">
                Chapter {currentSlideData.id} of {carouselSlides.length}
              </span>
            </div>
            ...
            <h3 className="text-xl md:text-2xl lg:text-3xl font-light text-white/90 mb-8">
              {currentSlideData.subtitle}
            </h3>
            
             <p className="text-lg md:text-xl lg:text-2xl text-white/85 leading-relaxed max-w-4xl mx-auto" style={{ fontFamily: 'Space Grotesk, monospace' }}>
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-full z-10">
        <div className="text-center mb-8">
          <h2 className="text-3xl md:text-4xl font-light text-white/90 mb-4">
            Full-Screen <span className="font-medium">Experience</span>
          </h2>
          <p className="text-white/70 max-w-2xl mx-auto">
            Immersive storytelling with dynamic backgrounds and smooth transitions.
          </p>
        </div>
      </div>
    </section>
