      ...
      <div className="container mx-auto px-6">
        <div className="max-w-5xl mx-auto">
          <div className="mb-12 max-w-3xl">
            ...
            <p className="text-olive-medium leading-relaxed" style={{ fontFamily: 'Space Mono, monospace', fontSize: 'clamp(1rem, 1.2vw, 1.25rem)' }}>{subheading}</p>
          </div>
            ...
            {labValues.map((item, index) => (
              <div key={index} className="rounded-2xl border overflow-hidden" style={{ borderColor: '#1B4229' }}>
                ...
                <div className="p-5 space-y-2" style={{ backgroundColor: '#FFFAEA' }}>
                  ...
                  <p className="text-olive-light" style={{ fontFamily: 'Space Mono, monospace', fontSize: 'clamp(0.75rem, 0.85vw, 0.9rem)' }}>{item.standard}</p>
                  <p className="text-olive-medium leading-relaxed" style={{ fontFamily: 'Space Mono, monospace', fontSize: 'clamp(0.85rem, 1vw, 1.05rem)' }}>{item.description}</p>
                </div>
              </div>
            ))}
          </div>
