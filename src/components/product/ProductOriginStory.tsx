    ...
    <section className="py-10 md:py-14 lg:py-16 xl:py-24" style={{ backgroundColor: "#FFFAEA" }}>
      <div className="container mx-auto px-6">
        <div className="text-center mb-12 md:mb-16">
          <p
            className="font-beverly font-bold text-olive-dark tracking-tight mx-auto text-2xl md:text-3xl lg:text-3xl xl:text-4xl"
        ...
        <div className="grid grid-cols-1 md:hidden lg:grid lg:grid-cols-3 lg:grid-rows-3 gap-4 max-w-[90vw] mx-auto lg:h-[calc(100vh-80px)]">
          {renderTile(0)}
