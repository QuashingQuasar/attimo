      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div
            ...
            style={{ backgroundColor: 'rgba(205, 219, 45, 0.15)', border: '1px solid rgba(205, 219, 45, 0.3)' }}
          >
            <h3
          ...
          <div
            className="rounded-2xl p-8 space-y-5"
            style={{ backgroundColor: 'rgba(255, 250, 234, 0.08)', border: '1px solid rgba(255, 250, 234, 0.15)' }}
          >
            <h3
              className="font-bold tracking-tight"
              style={{
