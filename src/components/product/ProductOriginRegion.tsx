...
export const ProductOriginRegion = () => {
  return (
    <section className="py-16 md:py-24" style={{ backgroundColor: '#10221B' }}>
      <div className="container mx-auto px-6">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <h2 className="font-bold tracking-tight" style={{ fontFamily: "'UDC Working Man Sans', sans-serif", color: '#B3E58C', fontSize: 'clamp(1.75rem, 3vw, 3rem)' }}>
              Harvested and Cold-Pressed in Sicily
            </h2>
            <p className="leading-relaxed" style={{ fontFamily: 'Space Grotesk, sans-serif', color: '#B3E58C', fontSize: 'clamp(1rem, 1.2vw, 1.25rem)' }}>
