      ...
      <div className="container mx-auto px-6">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="leading-relaxed" style={{ fontFamily: 'Space Mono, monospace', color: '#FFFAEA', fontSize: 'clamp(1rem, 1.2vw, 1.25rem)' }}>
            ...
            <p className="leading-relaxed" style={{ fontFamily: 'Space Mono, monospace', color: 'rgba(255, 250, 234, 0.8)', fontSize: 'clamp(0.95rem, 1.1vw, 1.15rem)' }}>
