...
export const IndustryProblem = () => {
  return (
    <section className="py-24 bg-[#1A431D] snap-start min-h-screen flex items-center">
      <div className="mx-auto px-4 w-[90vw]">
        ...
        <div className="mx-auto">
          ...
          <div className="text-left mb-20 max-w-5xl">
            <h2 className="text-5xl md:text-7xl font-light mb-8 leading-tight tracking-tight" style={{ color: '#1A431D' }}>
