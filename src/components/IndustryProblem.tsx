...
export const IndustryProblem = () => {
  return <section className="py-24 bg-[#1A431D] snap-start min-h-screen flex items-center">
      <div className="mx-auto px-4 w-[90vw]">
        ...
        <div className="mx-auto">
          ...
          <div className="text-left mb-20 max-w-5xl">
            <h2 className="text-5xl md:text-7xl font-light mb-8 leading-tight tracking-tight" style={{
                color: '#1A431D'
              }}>
              The <span className="font-medium italic">"extra virgin" lie</span>
            </h2>
             <p className="text-2xl md:text-3xl text-white/90 max-w-[60rem] leading-relaxed font-light" style={{
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-20">
            <div className="text-center p-12 border border-white/20 rounded-lg">
              <div className="text-7xl font-working-man font-light text-white mb-4">~80%</div>
               <p className="text-xl text-white/90 font-light leading-relaxed" style={{
                  fontFamily: 'Space Grotesk, monospace'
                }}>
          ...
          <div className="grid md:grid-cols-3 gap-16 mx-auto">
            ...
            <div className="space-y-6">
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-white tracking-tight leading-tight">Flavour and health are blended away</h3>
               <p className="text-lg md:text-xl text-white/80 leading-relaxed" style={{
                  fontFamily: 'Space Grotesk, monospace'
                }}>
