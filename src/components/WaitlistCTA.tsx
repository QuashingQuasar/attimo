...
export const WaitlistCTA = ({
  ...
  return <section className="py-20 snap-start relative overflow-hidden" style={{
    backgroundColor: '#B3E58C'
  }}>
      {/* Decorative background pattern */}
      <div className="absolute inset-0 opacity-15" style={{
      backgroundImage: 'url(/patterns/waitlist-tile.svg?v=2)',
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          lineHeight: '1.2'
        }}>Get messaged<br />when new oils come in</h2>
