  ...
  return <section className="py-12 md:py-16 lg:py-20 snap-start relative overflow-hidden" style={{ backgroundColor: '#B3E58C' }}>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mb-8 max-w-2xl mx-auto" style={{ fontFamily: 'Space Mono, monospace', color: '#1B4229', fontSize: 'clamp(1.25rem, 1.75vw, 1.75rem)', lineHeight: '1.6' }}>Harvest 2025 selection coming soon.</p>
