      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {testimonials.map((testimonial, index) => (
            <Card key={index} className="bg-white border-olive-light/30 shadow-lg">
              <CardContent className="p-8">
                ...
                <blockquote className="text-olive-medium text-lg leading-relaxed mb-6 italic">
                  "{testimonial.text}"
                </blockquote>
                <div className="border-t border-olive-light/20 pt-4">
                  <p className="font-bold text-olive-dark">{testimonial.name}</p>
