...
const testimonials = [
  ...
  { name: "Nicoleta P.", location: "Bucharest, Romania", date: "28 Nov 2025", text: "It tastes like I just picked the olives and pressed them myself. Super fresh and natural, I love it!", rating: 5, title: "Fresh harvest in a bottle" },
];
