  ...
  return (
    <section className="py-10 md:py-14 lg:py-16 snap-start min-h-[50vh] flex items-center relative overflow-hidden" style={{ backgroundColor: "#1A431D" }}>
      ...
      <div className="mx-auto relative z-10 w-full">
        <h2 className="text-center mb-8 font-beverly px-6" style={{ <h2 className="text-center mb-8 font-beverly px-6" style={{ fontSize: "clamp(1.6rem, 2.2vw, 2.2rem)", letterSpacing: "0.02em", maxWidth: "90vw", marginLeft: "auto", marginRight: "auto", color: headingColor }}>, letterSpacing: "0.02em", maxWidth: "90vw", marginLeft: "auto", marginRight: "auto", color: headingColor }}>
