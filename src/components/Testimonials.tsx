...
export const Testimonials = ({ headingColor = "rgb(205, 219, 45)" }: { headingColor?: string }) => {
  ...
  return (
    <section className="pt-12 md:pt-16 lg:pt-24 pb-12 md:pb-16 lg:pb-20 snap-start min-h-[50vh] flex items-center relative overflow-hidden" style={{ backgroundColor: "#1A431D" }}>
