...
export const YouMightAlsoLike = ({ currentHandle, accentColor }: YouMightAlsoLikeProps) => {
  ...
  return (
    <section
      className="py-20 md:pt-28 pb-3 md:pb-4 px-4 md:px-6 relative overflow-hidden"
      ...
      <div className="relative z-10 mx-auto" style={{ maxWidth: "1400px", transform: "scale(0.87)", transformOrigin: "top center" }}>
