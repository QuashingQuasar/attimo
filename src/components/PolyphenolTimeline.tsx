          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-slate-100">
            <div className="text-center">
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-slate-800 mb-6">
               ...
               <p className="text-lg md:text-xl text-slate-600 leading-relaxed" style={{ fontFamily: 'Inconsolata, monospace' }}>
                 {currentStep.content}
               </p>
            </div>
          </div>
                ...
                <div key={step.id} className="flex flex-col items-center">
                  ...
                  <div className="mt-4 text-center max-w-32">
                    ...
                    <div className={`text-xs mt-1 transition-colors duration-300 ${
                      activeStep === step.id ? 'text-emerald-600' : 'text-slate-400'
                    }`}>
          ...
          <div className="text-center mt-12">
            <div className="flex items-center justify-center space-x-4">
              <button
                ...
                className="px-6 py-2 bg-slate-100 text-slate-600 rounded-lg hover:bg-slate-200 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
              >
                Previous
              </button>
              ...
              <button
                ...
                className="px-6 py-2 bg-emerald-500 text-white rounded-lg hover:bg-emerald-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
              >
                Next
              </button>
            </div>
