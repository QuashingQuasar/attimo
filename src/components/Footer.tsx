      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="leading-relaxed mb-4" style={{ fontFamily: 'Space Mono, monospace', color: '#B3E58C' }}>
        ...
        <div className="border-t pt-6" style={{ borderColor: '#B3E58C' }}>
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm" style={{ fontFamily: 'Space Mono, monospace', color: '#B3E58C' }}>© 2026 ATTIMO. All rights reserved.</p>
            <div className="flex gap-6 text-sm" style={{ fontFamily: 'Space Mono, monospace' }}>
              <a href="#" className="hover:underline transition-colors" style={{ color: '#B3E58C' }}>Privacy Policy</a>
              <a href="#" className="hover:underline transition-colors" style={{ color: '#B3E58C' }}>Terms of Service</a>
            </div>
          </div>
        </div>
      </div>
