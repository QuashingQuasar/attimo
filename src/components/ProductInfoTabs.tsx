  ...
  return <div className="w-full">
      <Tabs defaultValue="details" className="w-full">
        <div className="border border-olive-dark rounded-2xl overflow-hidden bg-transparent">
          ...
          <TabsContent value="details" className="p-5 m-0 min-h-[180px] rounded-none bg-transparent">
          ...
          <TabsContent value="flavor" className="p-5 m-0 min-h-[180px] rounded-none bg-transparent">
          ...
          <TabsContent value="harvest" className="p-5 m-0 min-h-[180px] rounded-none bg-transparent">
          ...
          <TabsContent value="uses" className="p-5 m-0 min-h-[180px] rounded-none bg-transparent">
            <div className="text-olive-medium leading-relaxed" style={{
            fontFamily: 'Space Grotesk, monospace',
            fontSize: 'clamp(0.875rem, 1.1vw, 1.125rem)'
          }}>
