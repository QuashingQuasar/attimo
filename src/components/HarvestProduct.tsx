      ...
      <div className="container mx-auto px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            ...
            {/* Product Information & Flavor Profile Grid */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {/* Product Information */}
              <div className="space-y-6 bg-white/40 p-6 rounded-2xl border border-olive-light/10">
                <h3 className="text-lg font-semibold text-olive-dark mb-4">Product Details</h3>
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="text-olive-medium">drizzle over fresh food to bring out flavors</div>
                  </div>
                  <div>
                    <div className="text-sm font-semibold text-olive-dark uppercase tracking-wide mb-1">
                      STORE
              ...
              {/* Flavor Profile */}
              <div className="space-y-6 bg-white/40 p-6 rounded-2xl border border-olive-light/10">
                <h3 className="text-lg font-semibold text-olive-dark mb-4">Flavor Profile</h3>
                <div className="space-y-4">
                  {[
