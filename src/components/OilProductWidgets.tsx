...
export const OilProductWidgets = () => {
  return (
    ...
    className="pt-14 md:pt-20 pb-3 md:pb-4 px-4 md:px-6 relative overflow-hidden scroll-mt-0"
    style={{ backgroundColor: "hsl(var(--section-light))" }}>
      ...
      <div className="relative z-10 mx-auto -mb-[22rem] md:-mb-[18rem] lg:-mb-[18%]" style={{ maxWidth: "1400px", transform: "scale(0.79)", transformOrigin: "top center" }}>
