...
const faqs = [
  ...
  { question: "How fresh is the olive oil?", answer: "Every bottle is from the latest harvest and bottled quickly to preserve freshness. Unlike mass-produced oils that can sit for months or years, ATTIMO delivers oil within months of harvest. This ensures you get maximum flavor and health benefits." },
