...
const faqs = [
  ...
  },
  {
    ...
    answer: "ATTIMO sources from small, family-owned groves in Mediterranean regions known for exceptional olive oil. Each bottle comes from a single grove and is never blended, so you can trace exactly where your oil was produced. Current harvest is from Alentejo, Portugal."
  },
  {
  ...
  },
  {
    ...
    answerElement: (
      <>
        Absolutely. Every batch is third-party lab tested, and you can verify the quality markers yourself. We believe in complete transparency—you should know exactly what you're getting. View the lab results for the current 2024 harvest{" "}
        <a 
...
export const FAQ = () => {
  return (
    <section className="py-12 md:py-16 lg:py-24" style={{ backgroundColor: '#FFFAEA' }}>
