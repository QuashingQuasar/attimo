...
export const KleiaWay = () => {
  const tiles = [
    { title: "ALWAYS FRESH", text: "ATTIMO olive oil is always from the latest harvest. Pressed within hours after picking, bottled at peak freshness.", icon: "/icons/mortar.svg" },
  ...
  return (
    <section className="snap-start pt-8 md:pt-12 lg:pt-16 pb-16 md:pb-20 lg:pb-24" style={{ backgroundColor: 'hsl(var(--section-light))' }}>
      <div className="container mx-auto px-6" style={{ transform: "scale(0.83)", transformOrigin: "top center" }}>
