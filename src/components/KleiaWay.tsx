...
export const KleiaWay = () => {
  ...
  const renderTile = (index: number) => (
    <div className="rounded-xl p-5 h-[208px] lg:h-[248px]" style={{ backgroundColor: '#1B4229' }}>
  ...
  const renderVideo = (index: number) => (
    <div className="rounded-xl relative overflow-hidden h-[208px] lg:h-[248px]">
      <AutoplayVideo
        src={videos[index]}
  ...
  return (
    <section className="snap-start pt-14 md:pt-20 lg:pt-24 pb-11 md:pb-16 lg:pb-[77px]" style={{ backgroundColor: 'hsl(var(--section-light))' }}>
