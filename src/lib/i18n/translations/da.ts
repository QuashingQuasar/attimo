...
export const da: Dict = {
  ...
  faq: {
    ...
    a: {
      ...
      shippingText: "Vi sender i hele EU, fra Belgien og Holland til Finland og Portugal. Fragten starter ved 7 € for kernelande og går op til 22 € for mere fjerne destinationer – men de fleste ordrer kvalificerer til fri fragt, når du bestiller 2–4 flasker afhængigt af, hvor du bor. Ordrer i dag sendes i morgen, og levering tager 2–7 hverdage afhængigt af, hvor du er.",
