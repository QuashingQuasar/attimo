...
export const de: Dict = {
  ...
  product: {
    ...
    newBatchSubtitle:
      "Wir senden Ihnen eine E-Mail, sobald die Coratina d'Italia wieder verfügbar ist.", // REVIEW
    attrVariety: "Sorte",
    attrOrigin: "Herkunft",
    attrHarvest: "Ernte",
